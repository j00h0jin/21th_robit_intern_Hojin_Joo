...
class PanTiltCamera : public rclcpp_lifecycle::LifecycleNode
{
  ...
  private:
    ...
    void set_param_auto(std::string parameter_name, std::string auto_parameter_name, int parameter_value,
    ...
    std::string topic, camera_name, compressed_topic, camera_info_topic, pan_tilt_topic, pan_tilt_status_topic,
        camera_path, frame_id, resolution_str, format;
    double fps;
    int brightness, contrast, saturation, hue, gamma, sharpness, whitebalance, exposure, focus, zoom, pan, tilt, rotate;
